...
public class SpawnTile : InteractableObject
{
    ...
    {
        CombatGridSystem.instance.GetXY(transform.position, out x, out y);
        this.x = x;
        this.y = y;
    }
    ...
    {
        SquadMovementHandler s = CombatGridSystem.instance.UnitGrid.GetGridSystem().GetGridObject(x, y);
        return s != null;
    }
}